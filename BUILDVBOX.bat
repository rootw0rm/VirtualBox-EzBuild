...
set _openssl_link="https://www.openssl.org/source/openssl-1.1.0c.tar.gz"
...
set _vbox_sdk_link="http://download.virtualbox.org/virtualbox/5.1.12/VirtualBoxSDK-5.1.12-112440.zip"
set _vbox_link="http://download.virtualbox.org/virtualbox/5.1.12/VirtualBox-5.1.12.tar.bz2"
...
set _perl_link="http://downloads.activestate.com/ActivePerl/releases/5.24.0.2400/ActivePerl-5.24.0.2400-MSWin32-x64-300558.exe"
...
copy "%_build_dir%\vbox\kBuild\bin\win.amd64\kmkash.exe" "%_install_path%"
